...
# Define samples ---------------------------------------------------------------
sc81_05 <- studybase %>% filter(kontrol2015i==1 & born1981_2005==1) %>% select(pnr)
sc06_08 <- studybase %>% filter(kontrol2015i==1 & born2006_2008==1) %>% select(pnr)
sc <- studybase %>% filter(kontrol2015i==1) %>% select(pnr)

data_sc_any <- studybase %>% filter(sc_any==1) %>% select(pnr, w_sc_any)
